...
export function AppShell({ schema, schemaLoading, envelope, computing, onComputeEnvelope }: AppShellProps) {
  ...
  return (
    <div className="flex h-screen bg-surface-dark/50">
      {/* Left: Side panel - Airframe & Mission (as requested) */}
      <aside className="w-48 flex-shrink-0 p-3 flex flex-col">
        <GlassPanel className="flex-1 overflow-y-auto min-h-0" padding="p-4">
      ...
      <aside className="w-[420px] flex-shrink-0 flex flex-col p-3 overflow-hidden">
